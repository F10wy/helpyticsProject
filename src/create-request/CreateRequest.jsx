...
function initPage() {
  ...
  return (
    <section className="create-request-module">
      <>
  <header className="topbar">
    <div className="container nav">
      ...
      <nav className="nav-links">
        ...
        <a data-nav="create" href="/create-request">
          Create Request
        </a>
      </nav>
    </div>
  ...
  <main className="container">
    ...
    <section className="detail-grid section">
      <form className="form-card stack" data-create-form="">
        <div className="field">
        ...
        <div className="row">
          <button className="btn btn-secondary" type="button" data-fill-ai="">
