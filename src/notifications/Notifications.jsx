...
function initPage() {
  ...
  return (
    <section className="Notification-module">
      <>
  <header className="topbar">
    <div className="container nav">
      ...
      <nav className="nav-links">
        ...
        <a data-nav="notifications" href="/notifications">
          Notifications
        </a>
      </nav>
    </div>
  ...
  <main className="container">
    <section className="page-hero">
      <div className="panel">
        ...
        <p>
          Track new matches, solved items, AI insights, and reputation changes
          in one place.
        </p>
      </div>
    </section>
    <section className="section">
      <div className="panel">
        ...
        <div className="notif-list" data-notif-list="" />
      </div>
    </section>
  </main>
      </>
