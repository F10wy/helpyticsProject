...
const Home = () => {
  useEffect(() => {
    // 1. Set the page context that initPage uses
...
function initPage() {
  ...
  ({
    ...
    // 2. Call initPage directly instead of waiting for DOMContentLoaded,
    //    as the component is already mounted when useEffect runs.
    initPage();

    // Cleanup function to remove the dataset.page when the component unmounts
    return () => {
  ...
  <main>
      ...
      <div className="container hero-grid">
        <div className="hero-copy fade-in">
          ...
          <div className="hero-actions">
            ...
            <a className="btn btn-secondary" href="/create-request">
              Post a request
            </a>
          </div>
          <div className="stats-grid">
            <div className="stat-card">
              ...
              <div className="stat-value" data-stat-members>
                0
              </div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-value" data-stat-requests>
                0
              </div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-value" data-stat-solved>
                0
              </div>
        ...
        <div className="hero-panel fade-in">
          ...
          <p style={{ color: 'black' }}>
            A polished multi-page experience inspired by product platforms, with
            AI summaries, trust scores, contribution signals, notifications, and
            leaderboard momentum built directly in HTML, CSS, JavaScript, and
            LocalStorage.
          </p>
          <div className="stack">
    ...
    <section className="section">
      <div className="container">
        ...
        <div className="card-grid" data-featured-requests="" />
      </div>
    </section>
  </main>
