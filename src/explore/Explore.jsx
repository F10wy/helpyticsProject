...
function initPage() {
  ...
  ({
    ...
    // 2. Call initPage directly. In React, the DOM is ready when useEffect runs.
    initPage();
  ...
  <header className="topbar">
    <div className="container nav">
      ...
      <nav className="nav-links">
        ...
        <a data-nav="explore" href="/explore">
          Explore
        </a>
  ...
  <main className="container">
    <section className="page-hero">
      <div className="panel">
        ...
        <p style={{ color: 'black' }}>
          Filter by category, urgency, skills, and location to surface the best
          matches.
        </p>
      </div>
    </section>
    <section className="feed-grid section">
      <form className="panel stack" data-filter-form="">
        <div>
      ...
      <div className="stack" data-feed-results="" />
    </section>
  </main>
      </>
    </section>
