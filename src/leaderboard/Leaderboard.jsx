...
const Leaderboard = () => {
  useEffect(() => {
    document.body.dataset.page = "leaderboard";
  ...
  <header className="topbar">
    <div className="container nav">
      ...
      <nav className="nav-links">
        ...
        <a data-nav="leaderboard" href="/leaderboard">
          Leaderboard
        </a>
      </nav>
    </div>
  ...
  <main className="container">
    ...
    <section className="leader-grid section">
      <div className="panel">
        ...
        <h2>Rankings</h2>
        <div className="rank-list" data-rank-list="" />
      </div>
      <div className="panel">
        <p className="section-kicker">Badge system</p>
        <h2>Trust and achievement</h2>
        <div className="stack" data-badge-showcase="" />
      </div>
    </section>
  </main>
      </>
