...
import '../profile/assets/styles.css';
  ...
  <header className="topbar">
    <div className="container nav">
      ...
      <nav className="nav-links">
        ...
        <a data-nav="profile" href="/profile">
          Profile
        </a>
      </nav>
    </div>
  ...
  <main className="container">
    <section className="page-hero">
      <div className="panel">
        ...
        />
        <p>
          <span data-profile-role="" /> • <span data-profile-location="" />
        </p>
      </div>
    </section>
    <section className="profile-grid section">
      <div className="stack">
        <div className="panel">
          ...
          <div className="metric">
            ...
            <strong data-profile-trust="" />
          </div>
          <div className="metric">
            <span>Contributions</span>
            <strong data-profile-contributions="" />
          </div>
          <div className="stack">
            <div>
      ...
      <form className="form-card stack" data-profile-form="">
