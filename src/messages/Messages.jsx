...
function initPage() {
  ...
  return (
    <section className="messages-module">
      <>
  <header className="topbar">
    <div className="container nav">
      ...
      <nav className="nav-links">
        ...
        <a data-nav="messages" href="/messages">
          Messages
        </a>
      </nav>
    </div>
  ...
  <main className="container">
    ...
    <section className="detail-grid section">
      <div className="panel">
        ...
        <div className="message-list" data-message-list="" />
      </div>
      <form className="form-card stack" data-message-form="">
